...
These examples show exactly how to classify real messages. Study the reasoning — it reflects the edge cases you will encounter.

### ✅ ACTIONABLE → classify as "new"

| # | Source | Subject / Message | From | → Action | Why |
|---|--------|-------------------|------|----------|-----|
| 1 | Email | "Quarter End P09 March GS Open POs" | Supplier contact | **new** | Business request from a supplier about open purchase orders — requires review and response |
| 2 | Email | "Extron MPR – Documentation and Update Information" | Colleague | **new** | Colleague requesting documentation work — implies a deliverable the user must produce |
| 3 | Teams | "Kurze Frage haben wir einen Passwortmanager den wir benutzen?" | Colleague | **new** | Direct question needing a concrete answer — the sender is waiting for a specific response |
| 4 | Teams | "Könntest du zusammen mit Papa den Aufbau der Extron Software dokumentieren?" | Colleague | **new** | Explicit request with a clear deliverable ("dokumentieren") — the user is asked to create documentation |
| 5 | Teams | "my combine button doesn't work. nothing happens!" | Colleague | **new** | Support request — someone is blocked and needs the user's help to resolve a technical issue |

**Pattern:** Each of these has a **specific ask** or **clear deliverable** directed at the user. The sender expects a response, an action, or a result.

### ❌ NOT ACTIONABLE → classify as "skip"

| # | Source | Subject / Message | From | → Action | Why |
|---|--------|-------------------|------|----------|-----|
| 6 | Teams | "Which one you think is closer to what it does?" | Colleague | **skip** | Vague conversational fragment — no specific request, no deliverable, just casual back-and-forth chat |
| 7 | Teams | "Bin gerade noch in nem Call. Finden wir mal ein paar Minuten später?" | Colleague | **skip** | Scheduling / status message — no action item, just coordinating timing |
| 8 | Teams | "Geht es dir irgendwann 24.03 zwischen 13:00 und 16:00?" | Colleague | **skip** | Time-finding question — scheduling logistics, not a work deliverable |
| 9 | Email | "RE: Join Us for MSD Days 2026" | Event organizer | **skip** | Event invitation / FYI — informational, no specific action requested of the user |
| 10 | Teams | "hab mich für deine Session angemeldet, kann aber nicht teilnehmen" | Colleague | **skip** | FYI about attendance — purely informational, the user has nothing to do here |

**Pattern:** These are all conversational noise, scheduling logistics, or FYI messages. None of them contain a **specific deliverable** or **concrete action** the user must perform.

### Key Takeaway

The dividing line is: **"Would this become a to-do item on the user's task list?"**
- If YES → **new**
- If it's just conversation, scheduling, or information sharing → **skip**
