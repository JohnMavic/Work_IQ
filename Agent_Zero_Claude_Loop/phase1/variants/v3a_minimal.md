...
A message requires action based on its source:

**For emails:** A message requires action if **at least two** of these are true:
...
**For Teams messages:** A message requires action if **all** of these are true:
