...
> Version 2.0.0 · A personal AI-powered action-item tracker for Microsoft 365
...
- **Deep links** to original emails and Teams messages
- **Work logging** — describe what you did, AI searches your M365 data for matching communications
...
| Problem | Solution |
|---|---|
| Scan returns 500 error | Check terminal for timeout — enrichment can take 60-180s per task |
...
│   ├── LOG_WORK_SKILL.md        Work logging prompt template
