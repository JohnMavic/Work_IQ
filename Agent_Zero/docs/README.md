...
- **Default model for intent classification (since v2.8)** — Reasoning-based intent detection now uses the Copilot CLI's default model routing; the explicit Claude Opus 4.6 override was removed
